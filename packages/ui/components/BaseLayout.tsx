...
export const BaseLayout: React.FC<BaseLayoutProps> = ({
  ...
  return (
    <div className="flex h-screen w-screen">
      {/* Mind (Avalonstar) */}
      <div
        className={`${activeSite === 'mind' ? 'flex-auto' : 'w-24'} h-screen`}
      >
        <div>
          {activeSite === 'mind' ? (
            ...
            <div className="flex h-16 items-center justify-center border-b border-gray-200 bg-gray-100">
              <a
                href={
                  isDev ? `http://localhost:${devPorts.mind}` : siteUrls.mind
                }
      ...
      {/* Work (Bryan Veloso) */}
      <div
        className={`${activeSite === 'work' ? 'flex-1' : 'w-[256px]'} work h-screen bg-amber-50 p-6 px-6`}
      >
        <div>
          {activeSite === 'work' ? (
            ...
            <div className="h-screen items-center justify-center">
              <a
                href={
                  isDev ? `http://localhost:${devPorts.work}` : siteUrls.work
                }
                className=""
              >
        ...
        <div>
          {activeSite === 'play' ? (
            ...
            <div className="p-6">
              <a
                href={
                  isDev ? `http://localhost:${devPorts.play}` : siteUrls.play
                }
                className=""
              >
                Omnyist
