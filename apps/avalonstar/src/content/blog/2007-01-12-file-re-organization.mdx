...
significance: 2
description: It's that time of year again - time to buckle down and get my files
  in order. But with so many projects and an increasingly entropic nature,
  deciding on the perfect directory structure is proving to be a challenge.
---
