...
significance: 2
description: Let's start 2010 with some code, shall we? I dove into Niall
  Doherty's awesome Coda-inspired jQuery script and wrestled it into submission
  to build a slick carousel for Hello! Ranking.
---
...
<object width="510" height="287">
  <param name="allowfullscreen" value="true" />
  <param name="allowscriptaccess" value="always" />
  <param
    name="movie"
    value="http://vimeo.com/moogaloop.swf?clip_id=8559024&amp;server=vimeo.com&amp;show_title=1&amp;show_byline=1&amp;show_portrait=0&amp;color=00ADEF&amp;fullscreen=1"
  />
  <embed
    src="http://vimeo.com/moogaloop.swf?clip_id=8559024&amp;server=vimeo.com&amp;show_title=1&amp;show_byline=1&amp;show_portrait=0&amp;color=00ADEF&amp;fullscreen=1"
