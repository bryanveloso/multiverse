...
significance: 2
description: Steve Ballmer's chair-throwing, profanity-laced tirade against
  Google is not only unprofessional, it's a disgrace to respectable CEOs
  everywhere. As an aspiring business leader, Ballmer exemplifies exactly the
  kind of hotheaded, arrogant behavior I hope to avoid.
---
