...
significance: 3
description: In true Avalonstar fashion, the second annual ABX event went off
  without a hitch--despite the potential roadblocks that popped up along the
  way. From sponsorship issues to transportation woes, this year's bowling
  extravaganza tested our planning skills, but with some quick thinking and a
  lot of help, we pulled off a night that exceeded all expectations.
---
