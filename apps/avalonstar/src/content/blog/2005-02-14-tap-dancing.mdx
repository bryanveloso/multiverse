...
significance: 3
description: Reflecting on my early college days when Dance Dance Revolution was
  still a foreign concept to most, and how a simple dorm room practice session
  turned into an impromptu performance for half my floor. Things sure have
  changed since then, but the stares haven't.
---
