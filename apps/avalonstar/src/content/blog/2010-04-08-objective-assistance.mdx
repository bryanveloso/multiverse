...
significance: 2
description: After years of saying I'd never touch server-side code, I've found
  myself diving headfirst into the world of Objective-C and iPhone development.
  Let me share some of the resources that have helped me along the way,
  hopefully saving you from the same headaches I encountered.
---
...
2. If you don't mind college style lectures, then you'll be happy to hear that Stanford University has a great [iPhone Development course][2] (link opens iTunes) up _for free_ on iTunes U. You'll learn just as much, if not more from the professors (and guest speakers from Apple, Yelp, LinkedIn, etc.). however, I felt the teaching style left much to be desired. Maybe I just don't miss college, but Josh and Alan weren't always "there." In any case, it's still a great resource and they introduced some great methods that Simon didn't go over.
