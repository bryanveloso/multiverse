...
significance: 3
description: In the second part of my Linux noob chronicles, I dive deeper into
  the command line, learning to use vi, nano and screen while setting up a
  private game server. It's a bumpy but enlightening ride as this designer
  continues to navigate the uncharted waters of 'nix-land.
---
