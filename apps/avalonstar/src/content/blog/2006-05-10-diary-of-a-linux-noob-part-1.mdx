...
significance: 3
description: Parallels and my new MacBook Pro have opened the door to the world
  of Linux for this long-time Windows user. Join me as I stumble through my
  first attempts at using the command line and building from source - will I
