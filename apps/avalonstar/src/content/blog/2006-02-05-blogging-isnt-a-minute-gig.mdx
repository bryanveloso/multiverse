...
significance: 3
description: It's not as easy as it used to be - blogging isn't just a "sit down
  and write" sort of thing anymore. With so much to consider and the time it
  takes to really craft a post, you start to see that blogging is one
