...
significance: 1
description: Holy crap, the government did something right for once! A senator
  actually used common sense to question the broadcast flag mandate, and the
  RIAA lost their cool when they found out he owned an iPod. Imagine that!
---
...
And then, a voice from heaven, disguised as New Hampshire's **Republican** Junior Senator John Sununu, asked the question that should be asked at **every** meeting: _Do we need this mandate at all?_ What he said to back this up follows:
...
So if Sununu didn't speak up, a bill that defies the government's logic... no... logic itself, would pass? Come on, give me an example of a _restriction_ that _encourages creativity_. Anyway, this was my favorite bombshell of the article.
