...
significance: 4
description: Asking questions is a skill that's been crucial in my journey as a
  programmer. I'll take as much time as I need to craft that perfect question,
  because wasting anybody's time is the last thing I want to do.
---

As I start to write this I'm realizing that _asking the right questions_ is an important--if not required--skill in both design and programming, but since the latter feels a less natural to me, the development of said skill has been a lot more noticeable (read: _painful_).
