...
significance: 3
description: Users love to pit products against each other in imaginary battles,
  even when the companies themselves aren't trying to compete. It's an
  interesting aspect of human nature that we can't seem to let things just
  coexist without turning it into some kind of competition.
---
