...
significance: 3
description: After a five year hiatus, Dance Dance Revolution is back in the
  arcades and I couldn't be more excited. DDR has been a huge part of my life,
  from being the first connection with my fiancé to one of the first games I was
  ever good at, so I'm beside myself with anticipation for DDR SuperNOVA.
---

Why don't I start a meme, post something that nobody knows about you (that's been a big part of your life for _x_ number of years) and then pass it on. Okay, time to make a fool out of myself.
