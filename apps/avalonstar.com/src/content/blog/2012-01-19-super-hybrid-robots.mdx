...
significance: 5
description: After years of dabbling in everything from Cocoa to Puppet, I've
  come to associate myself with the concept of a hybrid—and found some
  surprising parallels with Mega Man along the way. My latest presentation at
  the GitHub summit explores what it means to be a "super hybrid robot."
---
...
<blockquote class="twitter-tweet">
  <p>
    Whew. I need to work on putting coherent sentences together, but at least the slides were pretty! ;){' '}
    <a href="https://twitter.com/search/%2523ghsummit">#ghsummit</a>
  </p>
  &mdash; Bryan Veloso (@bryanveloso){' '}
  <a href="https://twitter.com/bryanveloso/status/159751779964301312" data-datetime="2012-01-18T21:39:27+00:00">
    January 18, 2012
  </a>
</blockquote>
...
<div class="embed-container">
  {' '}
  <iframe
    src="https://player.vimeo.com/video/35558445?byline=0&amp;portrait=0"
    frameborder="0"
...
<div class="speakerdeck-container">
  <script src="https://speakerdeck.com/embed/4f187c6bac94e8008c00e33b.js"> </script>
</div>
