...
significance: 4
description: A decade of memories and a barrage of nostalgia-inducing blows as
  Avalonstar turns 10. Rather than try to contain the celebration in a mere 24
  hours, I've been hatching a plan over the past few months with the help of
  some close friends to create something special.
---
...
When it was time to make a decision, I knew I wanted _star_ at the end of it (I was having a lot of fun in astronomy class at the time), but I was split between two names—_avalon_ and _alero_—both with happened to be the names of cars at the time. Well, the choice I made is, as they say, history.
