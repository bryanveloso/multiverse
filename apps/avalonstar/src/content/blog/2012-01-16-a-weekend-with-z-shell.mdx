...
significance: 2
description: After a year of avoiding it, I finally took the plunge into the
  world of Z Shell and crafted a prompt that made me giggle with geeky
  satisfaction. Take a peek at my new setup and grab the code from my dotfiles
  repo.
---
