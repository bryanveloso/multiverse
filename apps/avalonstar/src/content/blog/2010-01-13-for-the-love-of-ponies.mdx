...
significance: 4
description: A year ago, the Django Pony was born out of a simple purchase on
  iStockPhoto. Now this fairy tale creature has become a symbol for the Django
  community, finding its way onto everything from memes to tattoos.
---
