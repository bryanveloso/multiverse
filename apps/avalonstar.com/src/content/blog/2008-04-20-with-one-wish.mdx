...
significance: 3
description: If you could have one HTML5/CSS3 property or attribute added into
  every modern browser today, what would it be? I'll play it clean and only
  state one—text-shadow, because all the bitmap elements have drop shadows, so
...
So with that, what's _your_ wish? :)
