...
significance: 2
description: Avalonstar comes limping in 12 hours late with a half-finished
  reboot, but there's a method to the madness. With new features on the horizon
  like tagging, the swag shop and a few tricks up my sleeve, it's better to
  launch at 75% than not at all - even if it means you get to see the process
