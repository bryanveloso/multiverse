...
significance: 3
description: Reflecting on the relationship between work and love, and how my
  winding path led me to an unlikely job at Facebook. It's funny how things work
  out sometimes, but I'm learning to appreciate the journey.
---
...
So to start out, I got `x` dollars. Let's call that my _base_ salary, since it was my first job right out of college. `x` would have been an awesome salary for a designer if Facebook were located in any other place _besides_ Silicon Valley. But `x` got Jen and I a very comfortable life, especially coming from a place where Jen had to work full-time while I was going to school with a part-time job. Jen was finally able to focus on her studies, while I took care of the bread.

However, that didn't last. No matter the reasons or circumstances, I had to move on. Although I started out as a _casual user_ of the product, I really did find great pleasure in working for that company and seeing them grow almost 10-fold in the time I was there.
