...
significance: 2
description: Mike Adams joins team Automattic and goes to town on bbPress,
  pushing the version to 1.0-a. Get ready for a bunch of cosmetic changes over
  the next few months to the entire line of products - it should be fun. ;)
---
