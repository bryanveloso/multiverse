...
significance: 3
description: Symbolic links have always baffled me - until now. Here's a simple
  way to use symlinks to maintain a single image directory across WordPress,
  bbPress and MediaWiki.
---
