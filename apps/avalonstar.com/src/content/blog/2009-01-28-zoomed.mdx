...
significance: 2
description: I have a bit of an addiction to zooming in on my Mac with ⌘ + 8.
  So I decided to record a session of me working zoomed in - it's a bit nuts,
  but hey, it's fun. :)
---
...
<object width="619" height="387">
  <param name="allowfullscreen" value="true" />
  <param name="allowscriptaccess" value="always" />
  <param
    name="movie"
    value="http://vimeo.com/moogaloop.swf?clip_id=2402462&amp;server=vimeo.com&amp;show_title=1&amp;show_byline=1&amp;show_portrait=0&amp;color=00ADEF&amp;fullscreen=1"
  />
  <embed
    src="http://vimeo.com/moogaloop.swf?clip_id=2402462&amp;server=vimeo.com&amp;show_title=1&amp;show_byline=1&amp;show_portrait=0&amp;color=00ADEF&amp;fullscreen=1"
