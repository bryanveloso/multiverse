...
significance: 2
description: It's time for another round of "Bryan reads books once in a blue
  moon!" Thanks to Dave for tagging me with this meme, but man, it's like
  getting smacked with a baton. Let's dive into my embarrassingly small book
  collection and the few gems I've actually had time to read lately.
---
