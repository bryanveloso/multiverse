...
significance: 3
description: Lumpia is more than just a Filipino appetizer, it's a delicious
  tradition. I share a recipe graciously borrowed from Chef Andy Pforzheimer,
  but let's be real - my mom's lumpia reigns supreme.
---
