...
significance: 3
description: Bryan rants about people expecting his site designs to become free
  WordPress themes, and shares a conversation with Kyle Neath on the difference
  between a design and a template.
---

Another anger post? Well, yes, another anger post. What triggered it you ask? This:

> I'm using your ChaoticSoul theme which is very nice, but Aries is definitely the best WP theme! _Gonna use it soon ok?_ Congrats.
...
<dialog>
  <dt>Kyle</dt>
  <dd>
    Well, I dunno it's weird I feel there's a distict difference between a deisgn and a template... comparing something
    like k2/hemingway/squible to something like my site, or totalspore
  </dd>
  <dt>Kyle</dt>
  <dd>
    like... for example, I would say something like what Jeff Croft has: [http://www2.jeffcroft.com/][2] is a design
    based on a template like hemingway: [http://www.warpspire.com/hemingway_example/][3]
  </dd>
  <dt>Kyle</dt>
  <dd>
    I've always seen a distinct difference between the two.. so when someone says "Can I download your Warpspire theme?"
    it bugs me
  </dd>
  <dt>Bryan</dt>
  ...
  <dt>Bryan</dt>
  <dd>
    Yes, but I don't think people should expect anything to be available as a template. Where's the fucking originality
    in that?
  </dd>
  <dt>Kyle</dt>
  <dd>
    I guess just because it's a set of templates (be it wordpress, MT, or HTML) doesn't mean it's a theme to download
  </dd>
  <dt>Bryan</dt>
  <dd>Yep.</dd>
  <dt>Kyle</dt>
  ...
  <dt>Kyle</dt>
  <dd>
    That's why Kubrick became so popular... it was a great starting point that allowed easy customization on top of it
  </dd>
  <dt>Kyle</dt>
  ...
  <dt>Bryan</dt>
  <dd>
    People have been ... I dunno, warped into thinking that they can view anything based off a blogging platform as
    something that they can use on their own site.
  </dd>
  <dt>Kyle</dt>
